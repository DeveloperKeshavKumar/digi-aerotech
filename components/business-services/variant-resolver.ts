...
const Hero = {
  ...
  variant2: dynamic(() => import('./hero/variant1')),
  variant3: dynamic(() => import('./hero/variant1'))
};
...
const Process = {
  ...
  variant2: dynamic(() => import('./process/variant1')), // fallback to variant1 for now
  variant3: dynamic(() => import('./process/variant1'))  // fallback to variant1 for now
};
