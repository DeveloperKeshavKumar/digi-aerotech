...
const WhyChooseUs = {
  variant1: dynamic(() => import('./why-choose-us/variant3')),
  variant2: dynamic(() => import('./why-choose-us/variant3')), // fallback to variant1 for now
  variant3: dynamic(() => import('./why-choose-us/variant3'))  // fallback to variant1 for now
};
