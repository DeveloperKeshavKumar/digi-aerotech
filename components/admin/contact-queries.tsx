...
export function ContactQueriesDashboard() {
    return (
...
function Page() {
    ...
    useEffect(() => {
        ...
        router.replace(`/admin?${newUrlParams.toString()}`, { scroll: false });
    }, [filters, router]);
    ...
    return (
        <div className="bg-white dark:bg-black text-gray-900 dark:text-gray-100 p-4 md:p-8 transition-colors">
            ...
            >
                ...
                {/* Data Table */}
                <div className="overflow-x-auto max-h-[30vh] overflow-scroll hide-scrollbar border border-gray-200 dark:border-gray-700 rounded-md">
