...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      initial: "Need ",
      headlineKeywords: [
        "Leads Generation for Gyms Fitness?",
        "Better Results?",
        "More Growth?",
        "Success?",
        "ROI?"
      ...
      brandLine: [
        { text: "Leads Generation for Gyms Fitness", gradient: false }
      ],
      subheadline: "Specialized leads generation strategies designed specifically for gyms fitness. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our Leads Generation for Gyms Fitness',
      subtitle: 'GYMS FITNESS SPECIALIZED SERVICES',
      description: 'Comprehensive leads generation solutions designed specifically for gyms fitness businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom leads generation strategy development tailored for gyms fitness market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of leads generation campaigns optimized for gyms fitness audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      ...
      description: 'A systematic approach to leads generation that delivers measurable results for gyms fitness businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom leads generation strategy tailored for your specific gyms fitness goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of leads generation campaigns with gyms fitness focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The leads generation services transformed our gyms fitness business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding leads generation expertise specifically for gyms fitness. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our leads generation can drive growth for your gyms fitness business.'
    }
  }
};
