...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      brandLine: [
        { text: "Local Seo for B2b Services", gradient: false }
      ],
      subheadline: "Specialized local seo strategies designed specifically for b2b services. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our Local Seo for B2b Services',
      subtitle: 'B2B SERVICES SPECIALIZED SERVICES',
      description: 'Comprehensive local seo solutions designed specifically for b2b services businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom local seo strategy development tailored for b2b services market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of local seo campaigns optimized for b2b services audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      title: 'Our Local Seo Process for B2b Services',
      subtitle: 'PROVEN METHODOLOGY',
      className: 'border-t border-border dark:border-gray-700',
      description: 'A systematic approach to local seo that delivers measurable results for b2b services businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom local seo strategy tailored for your specific b2b services goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of local seo campaigns with b2b services focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The local seo services transformed our b2b services business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding local seo expertise specifically for b2b services. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our local seo can drive growth for your b2b services business.'
    }
  }
};
