...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      brandLine: [
        { text: "Local Seo for E Commerce Brands", gradient: false }
      ],
      subheadline: "Specialized local seo strategies designed specifically for e commerce brands. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our Local Seo for E Commerce Brands',
      subtitle: 'E COMMERCE BRANDS SPECIALIZED SERVICES',
      description: 'Comprehensive local seo solutions designed specifically for e commerce brands businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom local seo strategy development tailored for e commerce brands market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of local seo campaigns optimized for e commerce brands audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      ...
      description: 'A systematic approach to local seo that delivers measurable results for e commerce brands businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom local seo strategy tailored for your specific e commerce brands goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of local seo campaigns with e commerce brands focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The local seo services transformed our e commerce brands business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding local seo expertise specifically for e commerce brands. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our local seo can drive growth for your e commerce brands business.'
    }
  }
};
