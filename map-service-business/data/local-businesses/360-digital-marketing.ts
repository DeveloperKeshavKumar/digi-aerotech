...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      brandLine: [
        { text: "360 Digital Marketing for Local Businesses", gradient: false }
      ],
      subheadline: "Specialized 360 digital marketing strategies designed specifically for local businesses. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our 360 Digital Marketing for Local Businesses',
      subtitle: 'LOCAL BUSINESSES SPECIALIZED SERVICES',
      description: 'Comprehensive 360 digital marketing solutions designed specifically for local businesses businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom 360 digital marketing strategy development tailored for local businesses market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of 360 digital marketing campaigns optimized for local businesses audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      title: 'Our 360 Digital Marketing Process for Local Businesses',
      subtitle: 'PROVEN METHODOLOGY',
      className: 'border-t border-border dark:border-gray-700',
      description: 'A systematic approach to 360 digital marketing that delivers measurable results for local businesses businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom 360 digital marketing strategy tailored for your specific local businesses goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of 360 digital marketing campaigns with local businesses focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The 360 digital marketing services transformed our local businesses business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding 360 digital marketing expertise specifically for local businesses. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our 360 digital marketing can drive growth for your local businesses business.'
    }
  }
};
