...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      brandLine: [
        { text: "360 Digital Marketing for Interior Designers", gradient: false }
      ],
      subheadline: "Specialized 360 digital marketing strategies designed specifically for interior designers. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our 360 Digital Marketing for Interior Designers',
      subtitle: 'INTERIOR DESIGNERS SPECIALIZED SERVICES',
      description: 'Comprehensive 360 digital marketing solutions designed specifically for interior designers businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom 360 digital marketing strategy development tailored for interior designers market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of 360 digital marketing campaigns optimized for interior designers audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      title: 'Our 360 Digital Marketing Process for Interior Designers',
      subtitle: 'PROVEN METHODOLOGY',
      className: 'border-t border-border dark:border-gray-700',
      description: 'A systematic approach to 360 digital marketing that delivers measurable results for interior designers businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom 360 digital marketing strategy tailored for your specific interior designers goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of 360 digital marketing campaigns with interior designers focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The 360 digital marketing services transformed our interior designers business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding 360 digital marketing expertise specifically for interior designers. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our 360 digital marketing can drive growth for your interior designers business.'
    }
  }
};
