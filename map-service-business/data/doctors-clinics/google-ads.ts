...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      brandLine: [
        { text: "Google Ads for Doctors Clinics", gradient: false }
      ],
      subheadline: "Specialized google ads strategies designed specifically for doctors clinics. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our Google Ads for Doctors Clinics',
      subtitle: 'DOCTORS CLINICS SPECIALIZED SERVICES',
      description: 'Comprehensive google ads solutions designed specifically for doctors clinics businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom google ads strategy development tailored for doctors clinics market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of google ads campaigns optimized for doctors clinics audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      title: 'Our Google Ads Process for Doctors Clinics',
      subtitle: 'PROVEN METHODOLOGY',
      className: 'border-t border-border dark:border-gray-700',
      description: 'A systematic approach to google ads that delivers measurable results for doctors clinics businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom google ads strategy tailored for your specific doctors clinics goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of google ads campaigns with doctors clinics focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The google ads services transformed our doctors clinics business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding google ads expertise specifically for doctors clinics. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our google ads can drive growth for your doctors clinics business.'
    }
  }
};
