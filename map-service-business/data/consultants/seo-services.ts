...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      subheadline: "Specialized seo services strategies designed specifically for consultants. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our Seo Services for Consultants',
      subtitle: 'CONSULTANTS SPECIALIZED SERVICES',
      description: 'Comprehensive seo services solutions designed specifically for consultants businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom seo services strategy development tailored for consultants market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of seo services campaigns optimized for consultants audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      title: 'Our Seo Services Process for Consultants',
      subtitle: 'PROVEN METHODOLOGY',
      className: 'border-t border-border dark:border-gray-700',
      description: 'A systematic approach to seo services that delivers measurable results for consultants businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom seo services strategy tailored for your specific consultants goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of seo services campaigns with consultants focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The seo services services transformed our consultants business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding seo services expertise specifically for consultants. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our seo services can drive growth for your consultants business.'
    }
  }
};
