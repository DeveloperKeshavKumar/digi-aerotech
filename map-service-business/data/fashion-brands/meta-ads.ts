...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      brandLine: [
        { text: "Meta Ads for Fashion Brands", gradient: false }
      ],
      subheadline: "Specialized meta ads strategies designed specifically for fashion brands. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our Meta Ads for Fashion Brands',
      subtitle: 'FASHION BRANDS SPECIALIZED SERVICES',
      description: 'Comprehensive meta ads solutions designed specifically for fashion brands businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom meta ads strategy development tailored for fashion brands market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of meta ads campaigns optimized for fashion brands audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      title: 'Our Meta Ads Process for Fashion Brands',
      subtitle: 'PROVEN METHODOLOGY',
      className: 'border-t border-border dark:border-gray-700',
      description: 'A systematic approach to meta ads that delivers measurable results for fashion brands businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom meta ads strategy tailored for your specific fashion brands goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of meta ads campaigns with fashion brands focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The meta ads services transformed our fashion brands business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding meta ads expertise specifically for fashion brands. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our meta ads can drive growth for your fashion brands business.'
    }
  }
};
