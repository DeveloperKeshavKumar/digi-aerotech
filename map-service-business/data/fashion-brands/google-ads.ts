...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      brandLine: [
        { text: "Google Ads for Fashion Brands", gradient: false }
      ],
      subheadline: "Specialized google ads strategies designed specifically for fashion brands. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our Google Ads for Fashion Brands',
      subtitle: 'FASHION BRANDS SPECIALIZED SERVICES',
      description: 'Comprehensive google ads solutions designed specifically for fashion brands businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom google ads strategy development tailored for fashion brands market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of google ads campaigns optimized for fashion brands audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      ...
      description: 'A systematic approach to google ads that delivers measurable results for fashion brands businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom google ads strategy tailored for your specific fashion brands goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of google ads campaigns with fashion brands focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The google ads services transformed our fashion brands business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding google ads expertise specifically for fashion brands. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our google ads can drive growth for your fashion brands business.'
    }
  }
};
