...
export const map: ServiceBusinessMap = {
  ...
  data: {
    ...
    hero: {
      ...
      brandLine: [
        { text: "Local Seo for Educational Institutions", gradient: false }
      ],
      subheadline: "Specialized local seo strategies designed specifically for educational institutions. Drive growth and achieve measurable results with our targeted approach.",
      ctaButtons: [
    ...
    typesOfServices: {
      title: 'Our Local Seo for Educational Institutions',
      subtitle: 'EDUCATIONAL INSTITUTIONS SPECIALIZED SERVICES',
      description: 'Comprehensive local seo solutions designed specifically for educational institutions businesses.',
      services: [
        {
          id: 1,
          title: 'Strategy & Planning',
          description: 'Custom local seo strategy development tailored for educational institutions market requirements.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 2,
          title: 'Implementation & Execution',
          description: 'Expert implementation of local seo campaigns optimized for educational institutions audience.',
          icon: React.createElement(IconStarsFilled, { size: 24 })
        },
        {
          id: 3,
    ...
    process: {
      ...
      description: 'A systematic approach to local seo that delivers measurable results for educational institutions businesses.',
      steps: [
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Custom local seo strategy tailored for your specific educational institutions goals.'
        },
        {
          id: 3,
          title: 'Implementation',
          description: 'Expert execution of local seo campaigns with educational institutions focus.'
        },
        {
          id: 4,
          title: 'Optimization',
    ...
    testimonials: {
      ...
      testimonials: [
        {
          id: '1',
          message: 'The local seo services transformed our educational institutions business. We saw incredible growth and results beyond our expectations.',
        ...
        {
          id: '2',
          message: 'Outstanding local seo expertise specifically for educational institutions. Highly recommend their services.',
    ...
    cta: {
      ...
      description: 'Contact us today for a comprehensive consultation and see how our local seo can drive growth for your educational institutions business.'
    }
  }
};
